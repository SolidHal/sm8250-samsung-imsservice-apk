...
.method static constructor <clinit>()V
    ...
    const-string v2, "Forbidden - Originating user not registered"
    ...
    const-string v2, "Forbidden - Not authorized for Presence"
    ...
    const-string v2, "Forbidden. Not Authorized for Service"
    ...
    const-string v3, "On eHRPD"

    invoke-direct {v0, v2, v3}, Lcom/sec/ims/util/SipError;-><init>(ILjava/lang/String;)V
    ...
    const-string v3, "Moved to eHRPD"
    ...
    const-string v3, "VoLTE setting Off"
    ...
    const-string v3, "On active 1X call"
    ...
    const-string v3, "On 1X call setup"
    ...
    const-string v3, "Subscriber not provisioned for VoLTE"
    ...
    const-string v2, "Video Upgrade Request In Progress"
...
.method public getFromRejectReason(I)Lcom/sec/ims/util/SipError;
    ...
    .line 86
    :cond_1
    sget-object v0, Lcom/sec/internal/constants/ims/SipErrorVzw;->CALL_REJECTED_BY_NOANSWER:Lcom/sec/ims/util/SipError;

    return-object v0

    .line 84
    :cond_2
    sget-object v0, Lcom/sec/internal/constants/ims/SipErrorVzw;->NOT_ACCEPTABLE_MOVED_TO_EHRPD:Lcom/sec/ims/util/SipError;

    return-object v0

    .line 76
    :cond_3
    sget-object v0, Lcom/sec/internal/constants/ims/SipErrorVzw;->CALL_REJECTED_BY_USER:Lcom/sec/ims/util/SipError;
