...
.method public static createImNotificationStatusReceived(Lcom/google/flatbuffers/FlatBufferBuilder;JIII)I
    .locals 1
    .param p0, "builder"    # Lcom/google/flatbuffers/FlatBufferBuilder;
    .param p1, "session_id"    # J
    .param p3, "uriOffset"    # I
    .param p4, "cpim_date_timeOffset"    # I
    .param p5, "statusOffset"    # I
    ...
    .line 31
    invoke-static {p0, p5}, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->addStatus(Lcom/google/flatbuffers/FlatBufferBuilder;I)V

    .line 32
    invoke-static {p0, p4}, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->addCpimDateTime(Lcom/google/flatbuffers/FlatBufferBuilder;I)V

    .line 33
    invoke-static {p0, p3}, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->addUri(Lcom/google/flatbuffers/FlatBufferBuilder;I)V

    .line 34
    invoke-static {p0, p1, p2}, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->addSessionId(Lcom/google/flatbuffers/FlatBufferBuilder;J)V
...
.method public static getRootAsImNotificationStatusReceived(Ljava/nio/ByteBuffer;Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;)Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;
    .locals 2
    .param p0, "_bb"    # Ljava/nio/ByteBuffer;
    .param p1, "obj"    # Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;
...
.method public __init(ILjava/nio/ByteBuffer;)V
    ...
    .line 14
    iput p1, p0, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->bb_pos:I

    iput-object p2, p0, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->bb:Ljava/nio/ByteBuffer;
...
.method public cpimDateTime()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->__offset(I)I
    ...
    iget v1, p0, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->bb_pos:I

    add-int/2addr v1, v0

    invoke-virtual {p0, v1}, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->__string(I)Ljava/lang/String;
...
.method public cpimDateTimeAsByteBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->__vector_as_bytebuffer(II)Ljava/nio/ByteBuffer;
...
.method public sessionId()J
    ...
    iget-object v1, p0, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->bb:Ljava/nio/ByteBuffer;

    iget v2, p0, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->bb_pos:I
...
.method public status(Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/ImNotificationParam;)Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/ImNotificationParam;
    ...
    invoke-virtual {p0, v1}, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->__indirect(I)I

    move-result v1

    iget-object v2, p0, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Notify_/ImNotificationStatusReceived;->bb:Ljava/nio/ByteBuffer;
