...
.method public static getRootAsRequestSendImComposingStatus(Ljava/nio/ByteBuffer;Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Request_/RequestSendImComposingStatus;)Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Request_/RequestSendImComposingStatus;
    .locals 2
    .param p0, "_bb"    # Ljava/nio/ByteBuffer;
    .param p1, "obj"    # Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Request_/RequestSendImComposingStatus;
...
.method public __init(ILjava/nio/ByteBuffer;)V
    ...
    .line 14
    iput p1, p0, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Request_/RequestSendImComposingStatus;->bb_pos:I

    iput-object p2, p0, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Request_/RequestSendImComposingStatus;->bb:Ljava/nio/ByteBuffer;
...
.method public sessionId()J
    ...
    invoke-virtual {p0, v0}, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Request_/RequestSendImComposingStatus;->__offset(I)I
    ...
    iget-object v1, p0, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Request_/RequestSendImComposingStatus;->bb:Ljava/nio/ByteBuffer;

    iget v2, p0, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Request_/RequestSendImComposingStatus;->bb_pos:I
...
.method public status(Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/ImComposingStatus;)Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/ImComposingStatus;
    ...
    iget v1, p0, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Request_/RequestSendImComposingStatus;->bb_pos:I

    add-int/2addr v1, v0

    invoke-virtual {p0, v1}, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Request_/RequestSendImComposingStatus;->__indirect(I)I

    move-result v1

    iget-object v2, p0, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Request_/RequestSendImComposingStatus;->bb:Ljava/nio/ByteBuffer;
...
.method public userAlias()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Request_/RequestSendImComposingStatus;->__string(I)Ljava/lang/String;
...
.method public userAliasAsByteBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/sec/internal/ims/core/handler/secims/imsCommonStruc/Request_/RequestSendImComposingStatus;->__vector_as_bytebuffer(II)Ljava/nio/ByteBuffer;
