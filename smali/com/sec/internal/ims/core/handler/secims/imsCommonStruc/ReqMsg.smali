...
.field public static final request_accept_slm_lmm_session:B = 0x39t

.field public static final request_accept_transfer_call:B = 0x14t

.field public static final request_alarm_wake_up:B = 0x6bt
...
.field public static final request_clear_all_call_internal:B = 0x71t
...
.field public static final request_handle_cmc_csfb:B = 0x5at

.field public static final request_handle_dtmf:B = 0x5et
...
.field public static final request_ish_accept_session:B = 0x5ct

.field public static final request_ish_start_session:B = 0x5bt

.field public static final request_ish_stop_session:B = 0x5dt
...
.field public static final request_ntp_time_offset:B = 0x6et

.field public static final request_open_sip_dialog:B = 0x67t

.field public static final request_options_cap_exchange:B = 0x4dt

.field public static final request_options_send_cmc_check_msg:B = 0x4et
...
.field public static final request_reject_slm_lmm_session:B = 0x3at
...
.field public static final request_rtp_stats_to_stack:B = 0x65t
...
.field public static final request_send_message_revoke_request:B = 0x64t
...
.field public static final request_send_sip:B = 0x66t

.field public static final request_send_slm_file:B = 0x32t

.field public static final request_send_text:B = 0x5ft
...
.field public static final request_silent_log_enabled:B = 0x6dt

.field public static final request_start_camera:B = 0x42t

.field public static final request_start_cmc_record:B = 0x72t

.field public static final request_start_ft_session:B = 0x2et

.field public static final request_start_im_session:B = 0x27t

.field public static final request_start_local_ring_back_tone:B = 0x68t

.field public static final request_start_media:B = 0x2at

.field public static final request_start_record:B = 0x6ft

.field public static final request_start_video_earlymedia:B = 0x59t

.field public static final request_stop_camera:B = 0x43t

.field public static final request_stop_local_ring_back_tone:B = 0x69t

.field public static final request_stop_record:B = 0x70t
...
.field public static final request_update_geolocation:B = 0x58t

.field public static final request_update_pani:B = 0x44t

.field public static final request_update_participants:B = 0x36t

.field public static final request_update_rat:B = 0x4ft

.field public static final request_update_sim_info:B = 0x6at

.field public static final request_update_srvcc_version:B = 0xat

.field public static final request_update_time_in_plani:B = 0x50t

.field public static final request_update_vce_config:B = 0x63t

.field public static final request_update_xq_enable:B = 0xbt

.field public static final request_vsh_accept_session:B = 0x61t

.field public static final request_vsh_start_session:B = 0x60t

.field public static final request_vsh_stop_session:B = 0x62t

.field public static final request_x509_cert_verify_result:B = 0x6ct

.field public static final request_xdm_fetch_document:B = 0x54t

.field public static final request_xdm_modify_contact:B = 0x57t

.field public static final request_xdm_update_aka_resp:B = 0x52t

.field public static final request_xdm_update_gba_data:B = 0x51t

.field public static final request_xdm_update_gba_key:B = 0x53t

.field public static final request_xdm_upload_contacts:B = 0x56t

.field public static final request_xdm_upload_pres_rules:B = 0x55t
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v57, "request_accept_slm_lmm_session"

    const-string/jumbo v58, "request_reject_slm_lmm_session"
    ...
    const-string/jumbo v73, "request_update_cmc_ext_call_count"

    const-string/jumbo v74, "request_send_media_event"

    const-string/jumbo v75, "request_send_relay_event"

    const-string/jumbo v76, "request_options_send_response"

    const-string/jumbo v77, "request_options_cap_exchange"

    const-string/jumbo v78, "request_options_send_cmc_check_msg"

    const-string/jumbo v79, "request_update_rat"

    const-string/jumbo v80, "request_update_time_in_plani"

    const-string/jumbo v81, "request_xdm_update_gba_data"

    const-string/jumbo v82, "request_xdm_update_aka_resp"

    const-string/jumbo v83, "request_xdm_update_gba_key"

    const-string/jumbo v84, "request_xdm_fetch_document"

    const-string/jumbo v85, "request_xdm_upload_pres_rules"

    const-string/jumbo v86, "request_xdm_upload_contacts"

    const-string/jumbo v87, "request_xdm_modify_contact"

    const-string/jumbo v88, "request_update_geolocation"

    const-string/jumbo v89, "request_start_video_earlymedia"

    const-string/jumbo v90, "request_handle_cmc_csfb"

    const-string/jumbo v91, "request_ish_start_session"

    const-string/jumbo v92, "request_ish_accept_session"

    const-string/jumbo v93, "request_ish_stop_session"

    const-string/jumbo v94, "request_handle_dtmf"

    const-string/jumbo v95, "request_send_text"

    const-string/jumbo v96, "request_vsh_start_session"

    const-string/jumbo v97, "request_vsh_accept_session"

    const-string/jumbo v98, "request_vsh_stop_session"

    const-string/jumbo v99, "request_update_vce_config"

    const-string/jumbo v100, "request_send_message_revoke_request"

    const-string/jumbo v101, "request_rtp_stats_to_stack"

    const-string/jumbo v102, "request_send_sip"

    const-string/jumbo v103, "request_open_sip_dialog"

    const-string/jumbo v104, "request_start_local_ring_back_tone"

    const-string/jumbo v105, "request_stop_local_ring_back_tone"

    const-string/jumbo v106, "request_update_sim_info"

    const-string/jumbo v107, "request_alarm_wake_up"

    const-string/jumbo v108, "request_x509_cert_verify_result"

    const-string/jumbo v109, "request_silent_log_enabled"

    const-string/jumbo v110, "request_ntp_time_offset"

    const-string/jumbo v111, "request_start_record"

    const-string/jumbo v112, "request_stop_record"

    const-string/jumbo v113, "request_clear_all_call_internal"

    const-string/jumbo v114, "request_start_cmc_record"

    filled-new-array/range {v0 .. v114}, [Ljava/lang/String;
