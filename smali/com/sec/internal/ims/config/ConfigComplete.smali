...
.method protected sendRCSAInfoToHQM(III)Z
    ...
    const-string/jumbo v2, "sendRCSAInfoToHQM : phoneId is invaild "
    ...
    invoke-interface {v1, p3}, Lcom/sec/internal/interfaces/ims/config/IConfigModule;->getRcsProfile(I)Ljava/lang/String;
    ...
    invoke-interface {v1, p3}, Lcom/sec/internal/interfaces/ims/config/IConfigModule;->getAcsTryReason(I)Lcom/sec/internal/constants/ims/DiagnosisConstants$RCSA_ATRE;

    move-result-object v1

    invoke-virtual {v1}, Lcom/sec/internal/constants/ims/DiagnosisConstants$RCSA_ATRE;->ordinal()I
    ...
    invoke-interface {v1, p3}, Lcom/sec/internal/interfaces/ims/config/IConfigModule;->resetAcsTryReason(I)V

    .line 144
    iget-object v1, p0, Lcom/sec/internal/ims/config/ConfigComplete;->mContext:Landroid/content/Context;

    const-string v2, "RCSA"

    invoke-static {v1, v2, p3, v3}, Lcom/sec/internal/ims/diagnosis/RcsHqmAgent;->sendRCSInfoToHQM(Landroid/content/Context;Ljava/lang/String;ILjava/util/Map;)Z
