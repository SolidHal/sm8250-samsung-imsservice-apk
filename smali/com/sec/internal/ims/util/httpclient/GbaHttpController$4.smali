...
.method constructor <init>(Lcom/sec/internal/ims/util/httpclient/GbaHttpController;ZLcom/sec/internal/helper/httpclient/HttpRequestParams;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[B[B)V
    ...
    iput-boolean p2, p0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$isGbaSupported:Z

    iput-object p3, p0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$requestParams:Lcom/sec/internal/helper/httpclient/HttpRequestParams;

    iput-object p4, p0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$url:Ljava/lang/String;

    iput-object p5, p0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$username:Ljava/lang/String;

    iput-object p6, p0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$bsfServer:Ljava/lang/String;

    iput-object p7, p0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$imei:Ljava/lang/String;

    iput-object p8, p0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$gbaType:[B

    iput-object p9, p0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$nafId:[B
...
.method public onComplete(Lcom/sec/internal/helper/httpclient/HttpResponseParams;)V
    ...
    .line 593
    iget-object v3, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->this$0:Lcom/sec/internal/ims/util/httpclient/GbaHttpController;

    iget-boolean v4, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$isGbaSupported:Z
    ...
    iget-object v6, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$requestParams:Lcom/sec/internal/helper/httpclient/HttpRequestParams;
    ...
    const-string/jumbo v6, "sendBsfRequestWithAuthorization(): onComplete: unexpected response code: "
    ...
    .line 602
    iget-object v4, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->this$0:Lcom/sec/internal/ims/util/httpclient/GbaHttpController;

    iget-boolean v5, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$isGbaSupported:Z
    ...
    iget-object v7, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->this$0:Lcom/sec/internal/ims/util/httpclient/GbaHttpController;

    iget-object v8, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$url:Ljava/lang/String;

    iget-object v9, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$username:Ljava/lang/String;

    iget-object v11, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$bsfServer:Ljava/lang/String;

    iget-object v12, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$imei:Ljava/lang/String;

    iget-object v13, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$gbaType:[B

    iget-object v14, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$nafId:[B

    iget-boolean v15, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$isGbaSupported:Z

    iget-object v10, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$requestParams:Lcom/sec/internal/helper/httpclient/HttpRequestParams;
    ...
    const-string/jumbo v7, "sendBsfRequestWithAuthorization(): onComplete: missing header: WWW-Authenticate"

    invoke-static {v5, v7}, Lcom/sec/internal/log/IMSLog;->e(Ljava/lang/String;Ljava/lang/String;)V

    .line 613
    iget-object v5, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->this$0:Lcom/sec/internal/ims/util/httpclient/GbaHttpController;

    iget-boolean v7, v0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$isGbaSupported:Z
...
.method public onFail(Ljava/io/IOException;)V
    ...
    iget-object v1, p0, Lcom/sec/internal/ims/util/httpclient/GbaHttpController$4;->val$requestParams:Lcom/sec/internal/helper/httpclient/HttpRequestParams;
