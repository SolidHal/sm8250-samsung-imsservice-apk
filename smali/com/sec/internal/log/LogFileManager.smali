...
.method private open(Ljava/nio/file/Path;)V
    ...
    invoke-direct {v4, v3, v0, v1}, Lcom/sec/internal/log/LogFileManager$MeteredWriter;-><init>(Ljava/io/Writer;J)V
...
.method private declared-synchronized rotate()V
    ...
    iget-object v3, p0, Lcom/sec/internal/log/LogFileManager;->mPaths:[Ljava/nio/file/Path;
    ...
    .line 60
    .end local p0    # "this":Lcom/sec/internal/log/LogFileManager;
    :cond_0
...
.method init()V
    ...
    .local v0, "i":I
    :goto_0
    iget v1, p0, Lcom/sec/internal/log/LogFileManager;->mMaxCount:I
    ...
    iget-object v5, p0, Lcom/sec/internal/log/LogFileManager;->mFullPath:Ljava/lang/String;
...
.method declared-synchronized write(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/sec/internal/log/LogFileManager;->mMeter:Lcom/sec/internal/log/LogFileManager$MeteredWriter;
    ...
    invoke-direct {p0, v2}, Lcom/sec/internal/log/LogFileManager;->open(Ljava/nio/file/Path;)V

    .line 77
    :cond_1
    iget-object v2, p0, Lcom/sec/internal/log/LogFileManager;->mMeter:Lcom/sec/internal/log/LogFileManager$MeteredWriter;

    invoke-virtual {v2, p1}, Lcom/sec/internal/log/LogFileManager$MeteredWriter;->write(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-wide v1, v1, Lcom/sec/internal/log/LogFileManager$MeteredWriter;->written:J

    iget v3, p0, Lcom/sec/internal/log/LogFileManager;->mMaxSize:I
