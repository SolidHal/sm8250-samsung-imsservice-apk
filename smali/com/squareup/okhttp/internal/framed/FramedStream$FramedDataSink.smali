...
.method private emitDataFrame(Z)V
    ...
    iget-object v6, p0, Lcom/squareup/okhttp/internal/framed/FramedStream$FramedDataSink;->sendBuffer:Lokio/Buffer;

    move-wide v7, v1

    invoke-virtual/range {v3 .. v8}, Lcom/squareup/okhttp/internal/framed/FramedConnection;->writeData(IZLokio/Buffer;J)V
    :try_end_4
    ...
    .end local p0    # "this":Lcom/squareup/okhttp/internal/framed/FramedStream$FramedDataSink;
    ...
    .line 514
    .restart local p0    # "this":Lcom/squareup/okhttp/internal/framed/FramedStream$FramedDataSink;
