...
.method private close(Lcom/squareup/okhttp/internal/framed/ErrorCode;Lcom/squareup/okhttp/internal/framed/ErrorCode;)V
    ...
    .line 463
    .local v1, "streamsToClose":[Lcom/squareup/okhttp/internal/framed/FramedStream;
    const/4 v2, 0x0

    .line 464
    .local v2, "pingsToCancel":[Lcom/squareup/okhttp/internal/framed/Ping;
    monitor-enter p0
    ...
    iget-object v5, p0, Lcom/squareup/okhttp/internal/framed/FramedConnection;->streams:Ljava/util/Map;
    ...
    check-cast v3, [Lcom/squareup/okhttp/internal/framed/FramedStream;
    ...
    iget-object v5, p0, Lcom/squareup/okhttp/internal/framed/FramedConnection;->pings:Ljava/util/Map;

    invoke-interface {v5}, Ljava/util/Map;->size()I

    move-result v5

    new-array v5, v5, [Lcom/squareup/okhttp/internal/framed/Ping;
    ...
    .line 488
    .local v5, "ping":Lcom/squareup/okhttp/internal/framed/Ping;
    invoke-virtual {v5}, Lcom/squareup/okhttp/internal/framed/Ping;->cancel()V

    .line 487
    .end local v5    # "ping":Lcom/squareup/okhttp/internal/framed/Ping;
    ...
    invoke-interface {v3}, Lcom/squareup/okhttp/internal/framed/FrameWriter;->close()V
    :try_end_3
    ...
    :goto_4
    :try_start_4
    iget-object v3, p0, Lcom/squareup/okhttp/internal/framed/FramedConnection;->socket:Ljava/net/Socket;
...
.method private newStream(ILjava/util/List;ZZ)Lcom/squareup/okhttp/internal/framed/FramedStream;
    ...
    iget-object v15, v7, Lcom/squareup/okhttp/internal/framed/FramedConnection;->frameWriter:Lcom/squareup/okhttp/internal/framed/FrameWriter;
    ...
    .line 269
    invoke-direct {v7, v8}, Lcom/squareup/okhttp/internal/framed/FramedConnection;->setIdle(Z)V
    :try_end_4
    ...
    :try_start_8
    invoke-interface {v0, v14, v2, v3}, Lcom/squareup/okhttp/internal/framed/FrameWriter;->pushPromise(IILjava/util/List;)V
    ...
    .end local p0    # "this":Lcom/squareup/okhttp/internal/framed/FramedConnection;
    ...
    .restart local p0    # "this":Lcom/squareup/okhttp/internal/framed/FramedConnection;
...
.method public ping()Lcom/squareup/okhttp/internal/framed/Ping;
    ...
    .line 389
    .restart local v0    # "ping":Lcom/squareup/okhttp/internal/framed/Ping;
    .restart local p0    # "this":Lcom/squareup/okhttp/internal/framed/FramedConnection;
    :catchall_0
    move-exception v2
...
.method public setSettings(Lcom/squareup/okhttp/internal/framed/Settings;)V
    ...
    .line 531
    .restart local p0    # "this":Lcom/squareup/okhttp/internal/framed/FramedConnection;
    .restart local p1    # "settings":Lcom/squareup/okhttp/internal/framed/Settings;
    :catchall_0
    move-exception v1
...
.method public shutdown(Lcom/squareup/okhttp/internal/framed/ErrorCode;)V
    ...
    .end local p0    # "this":Lcom/squareup/okhttp/internal/framed/FramedConnection;
    .end local p1    # "statusCode":Lcom/squareup/okhttp/internal/framed/ErrorCode;
    :try_start_7
    throw v2

    .restart local p0    # "this":Lcom/squareup/okhttp/internal/framed/FramedConnection;
    .restart local p1    # "statusCode":Lcom/squareup/okhttp/internal/framed/ErrorCode;
    :catchall_1
    move-exception v2
...
.method public writeData(IZLokio/Buffer;J)V
    ...
    invoke-interface {v0, p2, p1, p3, v3}, Lcom/squareup/okhttp/internal/framed/FrameWriter;->data(ZILokio/Buffer;I)V
